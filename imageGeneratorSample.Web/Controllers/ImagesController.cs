...
namespace imageGeneratorSample.Web.Controllers;
...
public class ImagesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CacheImage([FromBody] CacheImageGenerationRequest request)
    {
        try
        {
    ...
    public record CacheImageGenerationRequest
    {
